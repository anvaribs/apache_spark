# Databricks notebook source exported at Sun, 7 Aug 2016 23:19:44 UTC
# MAGIC %md
...
# TODO: Replace <FILL IN> with appropriate code
wordCountsGrouped = wordsGrouped.map(lambda (word, iterator): (word, sum(iterator)))
...
def removePunctuation(text):
    ...
    return regex.sub('', text).rstrip().lstrip().lower()
